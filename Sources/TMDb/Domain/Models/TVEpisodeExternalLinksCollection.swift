...
///
public struct TVEpisodeExternalLinksCollection: Identifiable, Codable, Equatable, Hashable, Sendable {
...
public extension TVEpisodeExternalLinksCollection {
    ...
    init(from decoder: Decoder) throws {
        ...
        let tvdbID = try container.decodeIfPresent(Int.self, forKey: .tvdbID)
        ...
        let tvdbLink = TVDbLink(tvdbTitleID: tvdbID)
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(tvdb?.id, forKey: .tvdbID)
